...
export default async function TeacherStudentDetailPage(props: {
  ...
  // Fetch tuition fees history - Teachers don't manage tuition but might need it for rendering if we didn't separate it strictly, but let's fetch it anyway or omit it.
  const tuitionFees: any[] = [] // Omit fetching since teacher doesn't need to see it
  ...
  return (
    <StudentManager 
      ...
      showTuition={false} // Teacher doesn't manage tuition
    />
  )
}
